...
- Only discuss LifeVault. Politely decline anything else and redirect.`;
    ...
    window.lvToggleChatbot = function () {
        ...
        document.getElementById('lv-chat-fab-icon').innerHTML = _chatOpen ? '✕' : '<img src="/logo.svg" alt="AI" style="width:80px;height:80px;border-radius:50%;object-fit:contain;display:block;min-width:80px;min-height:80px;">';
        if (_chatOpen) {
            seedWelcome();
