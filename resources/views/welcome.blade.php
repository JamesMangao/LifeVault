...
<button id="lv-chat-fab" onclick="lvToggleChatbot()" title="Chat with LifeVault AI">
    <span id="lv-chat-fab-icon"><img src="{{ asset('logo.svg') }}" alt="AI" style="width:44px;height:44px;border-radius:10px;object-fit:cover;"></span>
</button>
...
(function(){
    ...
    window.lvToggleChatbot=function(){_chatOpen=!_chatOpen;overlay.classList.toggle('lv-chat-visible',_chatOpen);fab.classList.toggle('lv-chat-open',_chatOpen);document.getElementById('lv-chat-fab-icon').innerHTML=_chatOpen?'✕':'<img src="/logo.svg" alt="AI" style="width:44px;height:44px;border-radius:10px;object-fit:cover;">';if(_chatOpen){seedWelcome();setTimeout(function(){if(input)input.focus();},350);}};
