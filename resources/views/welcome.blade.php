...
<button id="lv-chat-fab" onclick="lvToggleChatbot()" title="Chat with LifeVault AI">
    <span id="lv-chat-fab-icon"><svg width="28" height="28" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="bgGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#1a1035"/><stop offset="100%" style="stop-color:#0d0820"/></linearGradient><linearGradient id="purpleGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#7c3aed"/><stop offset="100%" style="stop-color:#6d28d9"/></linearGradient></defs><circle cx="100" cy="100" r="96" fill="url(#bgGrad)"/><rect x="28" y="48" width="122" height="86" rx="20" fill="url(#purpleGrad)"/><path d="M48 134 L36 160 L72 134Z" fill="url(#purpleGrad)"/><circle cx="69" cy="91" r="8" fill="white" opacity="0.92"/><circle cx="97" cy="91" r="8" fill="white" opacity="0.92"/><circle cx="125" cy="91" r="8" fill="white" opacity="0.92"/></svg></span>
</button>
    ...
    <div id="lv-chatbot-container">
        <div id="lv-chatbot-header">
            <div id="lv-chatbot-title">
                <div id="lv-chatbot-avatar"><svg width="36" height="36" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="bgGrad2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#1a1035"/><stop offset="100%" style="stop-color:#0d0820"/></linearGradient><linearGradient id="purpleGrad2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#7c3aed"/><stop offset="100%" style="stop-color:#6d28d9"/></linearGradient></defs><circle cx="100" cy="100" r="96" fill="url(#bgGrad2)"/><rect x="28" y="48" width="122" height="86" rx="20" fill="url(#purpleGrad2)"/><path d="M48 134 L36 160 L72 134Z" fill="url(#purpleGrad2)"/><circle cx="69" cy="91" r="8" fill="white" opacity="0.92"/><circle cx="97" cy="91" r="8" fill="white" opacity="0.92"/><circle cx="125" cy="91" r="8" fill="white" opacity="0.92"/></svg></div>
                <div>
...
/* ── Chatbot FAB ─────────────────────────────────────────── */
#lv-chat-fab{position:fixed;bottom:32px;right:32px;z-index:500;width:58px;height:58px;border-radius:50%;border:none;cursor:pointer;background:linear-gradient(135deg,#7c3aed,#4f8ef7);box-shadow:0 8px 32px rgba(124,58,237,.5);display:flex;align-items:center;justify-content:center;font-size:1.5rem;transition:transform .25s cubic-bezier(.34,1.56,.64,1),box-shadow .25s;animation:lv-fadeup .7s .8s ease both}
...
#lv-chatbot-avatar{width:36px;height:36px;border-radius:50%;background:linear-gradient(135deg,#a78bfa,#ec4899);display:flex;align-items:center;justify-content:center;font-size:1.1rem;flex-shrink:0}
...
(function(){
    ...
    function appendAIMsg(text,isTyping){var wrap=document.createElement('div');wrap.style.cssText='display:flex;flex-direction:column;gap:3px';if(isTyping)wrap.id='lv-typing-wrap';var row=document.createElement('div');row.className='lv-chat-msg lv-chat-ai';var ico=document.createElement('div');ico.className='lv-chat-ico';ico.innerHTML='<svg width="28" height="28" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="bgGrad3" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#1a1035"/><stop offset="100%" style="stop-color:#0d0820"/></linearGradient><linearGradient id="purpleGrad3" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#7c3aed"/><stop offset="100%" style="stop-color:#6d28d9"/></linearGradient></defs><circle cx="100" cy="100" r="96" fill="url(#bgGrad3)"/><rect x="28" y="48" width="122" height="86" rx="20" fill="url(#purpleGrad3)"/><path d="M48 134 L36 160 L72 134Z" fill="url(#purpleGrad3)"/><circle cx="69" cy="91" r="8" fill="white" opacity="0.92"/><circle cx="97" cy="91" r="8" fill="white" opacity="0.92"/><circle cx="125" cy="91" r="8" fill="white" opacity="0.92"/></svg>';var bubble=document.createElement('div');bubble.className='lv-chat-bubble';bubble.innerHTML=isTyping?'<span class="lv-chat-typing"><span></span><span></span><span></span></span>':'<p>'+renderMarkdown(text)+'</p>';row.appendChild(ico);row.appendChild(bubble);wrap.appendChild(row);if(!isTyping){var m=document.createElement('div');m.className='lv-chat-meta';m.style.paddingLeft='40px';m.textContent=getTime();wrap.appendChild(m);}messages.appendChild(wrap);messages.scrollTop=messages.scrollHeight;return bubble;}
    ...
    window.lvToggleChatbot=function(){_chatOpen=!_chatOpen;overlay.classList.toggle('lv-chat-visible',_chatOpen);fab.classList.toggle('lv-chat-open',_chatOpen);document.getElementById('lv-chat-fab-icon').innerHTML=_chatOpen?'✕':'<svg width="28" height="28" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="bgGrad4" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#1a1035"/><stop offset="100%" style="stop-color:#0d0820"/></linearGradient><linearGradient id="purpleGrad4" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#7c3aed"/><stop offset="100%" style="stop-color:#6d28d9"/></linearGradient></defs><circle cx="100" cy="100" r="96" fill="url(#bgGrad4)"/><rect x="28" y="48" width="122" height="86" rx="20" fill="url(#purpleGrad4)"/><path d="M48 134 L36 160 L72 134Z" fill="url(#purpleGrad4)"/><circle cx="69" cy="91" r="8" fill="white" opacity="0.92"/><circle cx="97" cy="91" r="8" fill="white" opacity="0.92"/><circle cx="125" cy="91" r="8" fill="white" opacity="0.92"/></svg>';if(_chatOpen){seedWelcome();setTimeout(function(){if(input)input.focus();},350);}};
