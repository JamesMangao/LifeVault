<div id="page-journal" class="page">
      ...
      <div style="margin-bottom:16px"><input type="text" id="journal-search" class="form-input" placeholder="🔍 Search by title, content or tags..." oninput="filterJournals()"></div>
